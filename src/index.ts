...
console.log('\n');
console.log('╔═════════════════════════════════════════════╗');
console.log('║     MARCANDO LIVRO COMO LIDO E AVALIADO     ║');
console.log('╚═════════════════════════════════════════════╝');
...
console.log('\n');
console.log('╔═════════════════════════════════════════════╗');
console.log('║           LIVROS LIDOS E NÃO LIDOS          ║');
console.log('╚═════════════════════════════════════════════╝');
...
console.log(`Total de livros lidos: ${totalLivrosLidos()}`);
console.log(`Percentual de livros lidos: ${percentualLivrosLidos().toFixed(2)}%`);
console.log(`Média de avaliação dos livros lidos: ${mediaAvaliacaoLivrosLidos().toFixed(2)}/5`);
console.log(`Título com maior avaliação: ${tituloMaiorAvaliacao()}`);
console.log(`Total de páginas lidas: ${totalPaginasLidas()}`);

//Classificar livros por década
console.log('\n');
console.log('╔═════════════════════════════════════════════╗');
console.log('║             LIVROS POR DÉCADA               ║');
console.log('╚═════════════════════════════════════════════╝');
...
console.log('╚═════════════════════════════════════════════╝');
//Exemplo para remover "1984"
const indice1984 = buscarLivro('1984')[0];
if (indice1984 !== undefined) {
